          ...
          children: [
            ...
            RichText(
              text: TextSpan(style: TextStyle(color: Colors.black), //, fontSize: 42),
                children: [
                  TextSpan(text: ' 피곤', style: TextStyle(fontSize: 39, fontWeight: FontWeight.bold, color:Colors.black38)),
                  TextSpan(text: '한 것 같아요', style: TextStyle(fontSize: 39, fontWeight: FontWeight.bold, color:Colors.black38)),
                ],
              ),
            ),
